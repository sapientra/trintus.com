...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(function Card(
  ...
  return <div ref={ref} className={cn('rounded-2xl border border-slate-800/80 bg-slate-950/60 shadow-panel', className)} {...props} />;
});
...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(function CardTitle(
  ...
  return <h3 ref={ref} className={cn('text-base font-semibold tracking-tight text-slate-50', className)} {...props} />;
});
